	...
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-login-form-2" role="form" action="<?php echo U('index/index/chaxun');?>" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="text-center" style="color:#ffffff;font-family:'方正喵呜体';">
						账单详情：
						语音通话为<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($call); ?></span>分钟，
						流量使用为<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($ll); ?></span>M,
						短信发送为<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($msg); ?></span>条<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						月租费用为<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($base_cost); ?></span>元， 
						语音通话费用为<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($call_cost); ?></span>元，
						短信费用为<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($msg_cost); ?></span>元.<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						账单分析：总费用中，月租占<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($base_percent); ?></span>%,
						通话费用占<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($call_percent); ?></span>%，短信费用占
						<span style="color:#FFDEAD;font-family:'方正喵呜体';"><?php echo ($msg_percent); ?></span>%.<br>
					</div>
					<br/>
