	...
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-login-form-2" role="form" action="<?php echo U('Login/checkLogin');?>" method="post">
				<div class="row">
					<div class="col-md-12">
						<h1 style="font-family:'方正喵呜体';">管理员登陆</h1>
					</div>
				</div>
				<div class="form-group">
			          <div class="col-md-12">
			            <a href="/index.php" class="pull-left" style="font-family:'方正喵呜体';" >点此返回主页</a>
						<a href="/index.php/index/login/checkreg.html" class="pull-right" style="font-family:'方正喵呜体';" >注册</a>
			          </div>
			        </div>
				<div class="form-inner">		
					...
					<div class="form-group">
				          <div class="col-md-12">
				            <input type="submit" value="登陆" class="btn myButton" style="font-family:'方正喵呜体';" >
				          </div>
				    </div>
